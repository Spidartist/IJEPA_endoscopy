...
from src.helper import load_checkpoint, init_model, init_opt, calc_rankme, alpha_req
from src.transforms import make_polyp_transforms
...
def main(args, resume_preempt=False):
    ...
    def save_checkpoint(epoch):
        ...
        # wandb.save(target_encoder.state_dict(), "target_encoder.pth")
        if rank == 0:
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for itr, (udata, masks_enc, masks_pred) in enumerate(unsupervised_loader):
            ...
            def train_step():
                ...
                return (float(loss), _new_lr, _new_wd, grad_stats, rm)
